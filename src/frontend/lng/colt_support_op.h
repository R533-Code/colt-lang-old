...
namespace clt::lng
{
  ...
  BinarySupport error_support(
      [[maybe_unused]] BinaryOp op, const TypeVariant& var) noexcept;
  ...
  BinarySupport opaque_ptr_support(
      [[maybe_unused]] BinaryOp op, const TypeVariant& rhs) noexcept;
  ...
  BinarySupport ptr_support(
      const PointerType& tkn, [[maybe_unused]] BinaryOp op,
      const TypeVariant& var) noexcept;
